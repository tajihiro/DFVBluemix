var count = (function toFraction(BigNumber) {
    ...
    */
    ...
    assertException(function () {new BigNumber('12.3e1').toFraction(Number)}, ".toFraction(new Number)");
    assertException(function () {new BigNumber('12.3e1').toFraction(String)}, ".toFraction(new String)");
